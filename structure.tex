...
\newfontfamily\cvtextfont[Path=fonts/]{Xerox Serif Narrow Italic} % Create a new font family for the cursive font Freebooter Script, provided with the template in the fonts folder
...
\definecolor{headings}{HTML}{0D19FF} % Dark red colour for headings
\definecolor{shade}{HTML}{0DFFE4} % Peach colour for the contact information box
\definecolor{linkcolor}{HTML}{0067B4} % 25% desaturated headings colour for links
