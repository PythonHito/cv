...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\educationentry{2017 - 2020 (expected)} % Duration
	{Beachelor of Science} % Degree
	{First (as of the end of second year)} % Honours, achievements or distinctions (e.g. first class honours)
...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{}{Git version control}{}
	\tableentry{}{C (Embedded)}{}
	\tableentry{}{Linux}{spaceafter}
	%------------------------------------------------
	
	\tableentry{Learning}{Rust}{}
	\tableentry{}{CMake}{}
